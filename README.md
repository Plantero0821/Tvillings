...
- This project uses the project structure from discord's tutorial on how to make your own discord bot (https://docs.discord.com/developers/quick-start/getting-started, repo https://github.com/discord/discord-example-app)
